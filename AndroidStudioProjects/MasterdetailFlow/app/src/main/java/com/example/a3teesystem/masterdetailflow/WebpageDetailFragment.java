package com.example.a3teesystem.masterdetailflow;
...
import com.example.a3teesystem.masterdetailflow.dummy.DummyContent;

/**
 * A fragment representing a single Web_page detail screen.
...
public class WebpageDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((WebView)rootView.findViewById(R.id.Webpage_area)).loadUrl(mItem.url);
        }
